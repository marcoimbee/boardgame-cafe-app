...
public class ControllerViewSignUp implements Initializable {
    ...
    public void onClickFinish(ActionEvent event) {
        ...
        String[] campi = {"First Name", "Last Name",
                          "Country", "Gender", "Date of Birth",
                          "Email", "Username", "Password", "Repeated Password"};
        ...
        for (String campo : campi) {
            switch (campo) {
                case "First Name":
                    if (firstName != null) nonNullValues.add(firstName);
                    break;
                case "Last Name":
                    if (lastName != null) nonNullValues.add(lastName);
                    break;
                case "Country":
                    if (country != null) nonNullValues.add(country);
                    break;
                case "Gender":
                    if (gender != null) nonNullValues.add(gender);
                    break;
                case "Date of Birth":
                    if (dateOfBirth != null) nonNullValues.add(dateOfBirth.toString());
                    break;
                case "Email":
                    if (email != null) nonNullValues.add(email);
                    break;
                case "Username":
                    if (!username.isEmpty()) nonNullValues.add(username);
                    break;
                case "Password":
                    if (password != null) nonNullValues.add(password);
                    break;
                case "Repeated Password":
                    if (repeatedPassword != null) nonNullValues.add(repeatedPassword);
                    break;
                default:
                    break;
            }
        ...
        // Stampare i valori non nulli
        System.out.println("Valori non nulli:");
        for (String value : nonNullValues) {
            System.out.println(value);
        }

        // Controllare e stampare le variabili che sono null
        for (String campo : campi) {
            switch (campo) {
                case "First Name":
                    if (firstName.isEmpty()) System.out.println("First Name è null.");
                    break;
                case "Last Name":
                    if (lastName.isEmpty()) System.out.println("Last Name è null.");
                    break;
                case "Country":
                    if (country == null) System.out.println("Country è null.");
                    break;
                case "Gender":
                    if (gender == null) System.out.println("Gender è null.");
                    break;
                case "Date of Birth":
                    if (dateOfBirth == null) System.out.println("Date of Birth è null.");
                    break;
                case "Email":
                    if (email == null || email.isEmpty()) System.out.println("Email è null.");
                    break;
                case "Username":
                    if (username.isEmpty()) System.out.println("Username è null.");
                    break;
                case "Password":
                    if (password == null || password.isEmpty()) System.out.println("Password è null.");
                    break;
                case "Repeated Password":
                    if (repeatedPassword == null || repeatedPassword.isEmpty()) System.out.println("Repeated Password è null.");
                    break;
                default:
                    break;
            }
