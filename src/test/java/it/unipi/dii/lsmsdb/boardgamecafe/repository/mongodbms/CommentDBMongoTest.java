...
//    private CommentDBMongo commentDBMongo;
    ...
    private CommentModelMongo testComment;
    ...
    private void init() {
        ...
        testComment = new CommentModelMongo(
                samplePostId,
                sampleUsername,
                sampleCommentText,
                sampleDate
    ...
    public void GIVEN_comment_WHEN_inserted_THEN_gets_inserted() {
        ...
        boolean shouldReturnTrue = postDBMongo.addCommentInPostArray(samplePost, testComment);
...
//        assertTrue(commentDBMongo.updateComment(sampleComment.getId(), updatedComment));
    ...
    public void GIVEN_post_id_WHEN_search_by_post_id_THEN_recent_comments_are_returned() {
        ...
        assertEquals(1, postDBMongo.getRecentCommentsByPostId(testPostId, 1, 0).size());
    }
